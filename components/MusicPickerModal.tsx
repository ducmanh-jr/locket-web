...
// Curated 100% Vietnamese Chill & Gentle Music List (Acoustic, V-Pop, Indie Chill for FB Stories)
const PRESET_TRENDING_TRACKS: ExtendedTrack[] = [
  ...
  },
  {
    ...
    artist: 'Chillies (Acoustic Vibe)',
    playsCount: '1,9 triệu',
    chorusOffset: 35,
    cover_url: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=200&auto=format&fit=crop&q=80',
    preview_url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3',
  },
