        ...
        {showFilterModal && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-sm bg-[#120810]/95 backdrop-blur-2xl border border-white/10 rounded-t-3xl sm:rounded-3xl p-5 text-left space-y-4 shadow-[0_-12px_50px_rgba(0,0,0,0.6)] max-h-[80vh] flex flex-col"
            >
              {/* Modal Header */}
                  ...
                  .map((member) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSelected && (
                          <Check className="w-4 h-4 text-[#5c243c] stroke-[3]" />
                        )}
                      </button>
                    );
                  })}
